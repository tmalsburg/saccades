...
#+BEGIN_SRC R :exports both :results output graphics :file plots/zl9JSz.pdf :width 7 :height 4
library(tidyverse)
...
#+BEGIN_SRC R :exports both :results output graphics :file plots/2GxXsD.pdf :width 7 :height 4
diagnostic.plot(samples, fixations, start.time=2000, duration=10000, interactive=FALSE, ylim=c(0,1000))
#+END_SRC

#+RESULTS:
[[file:plots/2GxXsD.pdf]]
...
#+BEGIN_SRC R :exports both :results output graphics :file plots/YGr5KW.pdf :width 7 :height 4
diagnostic.plot(samples, fixations, start.time=235800, duration=900, interactive=FALSE, ylim=c(0,1000))
#+END_SRC

#+RESULTS:
[[file:plots/YGr5KW.pdf]]
